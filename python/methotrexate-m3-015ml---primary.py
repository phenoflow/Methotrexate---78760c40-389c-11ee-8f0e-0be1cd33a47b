...
codes = [{"code":"27400","system":"gprdproduct"},{"code":"27404","system":"gprdproduct"},{"code":"40280","system":"gprdproduct"},{"code":"40301","system":"gprdproduct"},{"code":"46039","system":"gprdproduct"}];
REQUIRED_CODES = 1;
